		...
		<section class="container-fluid">
			...
			<article class="row">
				<div class="buttons col-xs-12 col-sm-4 col-sm-offset-8">
					<a href="#" class="btn"><span class="glyphicon glyphicon-trash"></span> Borrar Tarea</a>
					<a href="#" class="btn">Editar Tarea</a>
				</div>
			</article>
			<aside class="col-xs-12 col-sm-3">
				<div class="col-xs-12">
					<ul class="pInfo">
						<li>
							<p>Título del Proyecto: <span>Proyecto01</span></p>
						</li>
						<!--Asignacion para el identificador --> 
						<li>
							<p>Identificador <span>test</span></p>
						</li>
						<li>
